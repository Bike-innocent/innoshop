...
//           <button onClick={toggleOffcanvas} className="text-xl font-bold">
...
//                 </li>
//                 <li className="menu-item">
//                   <Link to="/our-store" className="item-link">
//                     Our Store
//                   </Link>
//                 </li>
//                 <li className="menu-item">
...
//         </div>
//       </div>
//       <OffCanvas offcanvasRef={offcanvasRef} closeOffcanvasAndNavigate={closeOffcanvasAndNavigate} />
//     </header>
//   );
// }
...
//       </div>
//       {/* Offcanvas Reference */}
//       <div ref={offcanvasRef} id="mobileMenu" className="offcanvas offcanvas-start" tabIndex="-1"></div>
//     </header>
//   );
// }
...
//   return (
//     <header
//       className={`header-default fixed top-0 left-0 right-0 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}
//     >
//       <div className="px_15 lg-px_40">
//         <div className="flex wrapper-header align-items-center">
//           <button onClick={toggleOffcanvas} className="text-xl font-bold">Menu</button>
...
import { Offcanvas } from 'bootstrap';
import OffCanvas from './OffCanvas'; // Ensure this path is correct for importing OffCanvas
    ...
    >
      <div className="px_15 lg-px_40">
        <div className="flex wrapper-header align-items-center">
          ...
          <div className="w-1/3">
            <Link to="/" className="logo-header text-3xl font-bold">Innoshop</Link>
          </div>
          <div className="w-2/3 tf-md-hidden">
            <nav className="box-navigation text-center">
              <ul className="box-nav-ul flex align-items-center justify-content-center gap-40">
