...
//     <>
//       {/* <!-- Header --> */}
//         <header id="header" class="header-default shadow-md">
...
//                         </a>
//                     </div>
//                     <div class="col-lg-4 col-xl-6 tf-md-hidden ">
//                         <nav class="box-navigation text-center">
//                             <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-40">
//                                 <li class="menu-item ">
//                                     <Link to="/" class="item-link">Home </Link>
                                  
//                                 </li>
//                                 <li class="menu-item ">
//                                     <Link to="/shop" class="item-link">Shop</Link>
                                    
//                                 </li>
//                                 <li class="menu-item " >
//                                     <Link to="/products" class="item-link">Products</Link>
                                 
//                                 </li>
//                                 <li class="menu-item ">
//                                     <Link to="/pages" class="item-link">Pages</Link>
                                    
//                                 </li>
//                                 <li class="menu-item ">
//                                     <Link to="/blogs" class="item-link">Blogs</Link>
        ...
        <div className="row wrapper-header align-items-center">
          ...
          <div className="col-lg-4 col-xl-6 tf-md-hidden">
            <nav className="box-navigation text-center">
              <ul className="box-nav-ul d-flex align-items-center justify-content-center gap-40">
                ...
                <li className="menu-item">
                  <Link to="/pages" className="item-link">
                    Pages
                  </Link>
                </li>
                <li className="menu-item">
