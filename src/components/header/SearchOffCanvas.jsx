...
function SearchOffCanvas({ offcanvasRef, closeOffcanvasAndNavigate }) {
  ...
  return (
    ...
    >
      ...
      <header className="flex justify-between items-center p-4 bg-white sticky top-0 z-10 shadow-sm border-b border-gray-200">
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-white">
        ...
        <div className="tf-inspiration-section">
          <h3 className="font-bold mb-2">Need some inspiration?</h3>
          <div className="space-y-4">
            {[
              { src: "assets/images/products/white-3.jpg", title: "Cotton jersey top", price: "$8.00", originalPrice: "$10.00" },
              { src: "assets/images/products/white-2.jpg", title: "Mini crossbody bag", price: "$18.00" },
              { src: "assets/images/products/white-1.jpg", title: "Oversized Printed T-shirt", price: "$18.00" },
            ].map(({ src, title, price, originalPrice }, idx) => (
              <div key={idx} className="flex items-center">
                <Link to="product-details" onClick={() => closeOffcanvasAndNavigate('/product-details')}>
                  <img src={src} alt={title} className="w-16 h-16 mr-4" />
                </Link>
                <div>
                  <Link to="product-details" onClick={() => closeOffcanvasAndNavigate('/product-details')} className="font-semibold text-gray-800">
                    {title}
                  </Link>
