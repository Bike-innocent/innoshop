...
// function OffCanvas({ offcanvasRef, closeOffcanvasAndNavigate }) {
//   useEffect(() => {
...
//     <div>
//       {/* Off-canvas */}
//       <div className="offcanvas offcanvas-start canvas-mb" tabIndex="-1" id="mobileMenu" ref={offcanvasRef}>
...
//         <div className=" bg-white p-3 overflow-auto">
//           <ul className="nav-ul-mb" id="wrapper-menu-navigation ">
//             <li className="nav-mb-item">
//               <a onClick={() => closeOffcanvasAndNavigate("/")} className="collapsed mb-menu-link current">Home</a>
//             </li>
//             <li className="nav-mb-item">
//               <a onClick={() => closeOffcanvasAndNavigate("/shop")} className="collapsed mb-menu-link">Shop</a>
//             </li>
//             <li className="nav-mb-item">
//               <a onClick={() => closeOffcanvasAndNavigate("/about-us")} className="collapsed mb-menu-link">About Us</a>
//             </li>
//             <li className="nav-mb-item">
//               <a onClick={() => closeOffcanvasAndNavigate("/contact-us")} className="collapsed mb-menu-link">Contact Us</a>
//             </li>
//             <li className="nav-mb-item">
//               <a onClick={() => closeOffcanvasAndNavigate("/our-store")} className="collapsed mb-menu-link">Our Store</a>
//             </li>
//             <li className="nav-mb-item">
//               <a onClick={() => closeOffcanvasAndNavigate("/faq")} className="collapsed mb-menu-link">FAQ</a>
//             </li>
//           </ul>
//           <div className="mb-other-content">
//             <div className="flex group-icon">
