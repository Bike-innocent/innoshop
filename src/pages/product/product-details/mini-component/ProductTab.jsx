...
// Define separate components for each tab's content
const DescriptionContent = () => (
  <div className="p-3 md:p-4">
    <p className="mb_30">
      Button-up shirt sleeves and a relaxed silhouette. It’s tailored with drapey,
      crinkle-texture fabric made from LENZING™ ECOVERO™ Viscose...
    </p>
...
const ReturnPoliciesContent = () => (
  <div className="p-3 md:p-4">
    <p>Our return policies are outlined here...</p>
  </div>
);
...
function ProductTab() {
  ...
  const renderContent = () => {
    if (activeTab === 'Description') return <DescriptionContent />;
    if (activeTab === 'Review') return <ReviewContent />;
    if (activeTab === 'Shipping') return <ShippingContent />;
    if (activeTab === 'Return Policies') return <ReturnPoliciesContent />;
    return null;
  };
