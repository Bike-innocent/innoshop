...
function BestSeller() {
    ...
    const updateArrows = () => {
        const scrollContainer = scrollContainerRef.current;
        if (scrollContainer) {
            const tolerance = 2; // Adjust tolerance to catch near-zero scroll values
                ...
                {loading ? (
                    ...
                    >
                        {products.map((product) => (
                            <div key={product.id} className="flex-none w-1/2 sm-1/3 md:w-1/4 lg:w-1/5 md:px-1">
                                    ...
                                    <div className="card-product-wrapper">
                                        <Link to={`/product/${product.slug}`} className="product-img">
                                            ...
                                            <img
                                                ...
                                                src={product.images[1]?.image_path || product.images[0]?.image_path}
                                                alt={product.name}
                                            />
                                        </Link>
                                        ...
                                        <div className="list-product-btn absolute-3">
                                            <button className="box-icon quick-add style-2">
                                                <span className="icon-bag"></span>
                                                <span className="text">QUICK ADD</span>
                                            </button>
                                            <button className="box-icon quickview style-2">
