...
//                     <Link to="/check-out" class="tf-btn w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
//                         <span>Check out</span>
//                     </Link>
//                 </div>
...
function CheckOutSection({ subTotal }) {
    return (
        ...
        <div class="tf-cart-footer-inner">
            ...
            <div class="tf-page-cart-checkout">
                ...
                <div class="cart-checkbox">
                    <input type="checkbox" class="tf-check" id="cart-gift-checkbox"/>
                    <label for="cart-gift-checkbox" class="fw-4">
                        <span>Do you want a gift wrap?</span> Only <span class="fw-5">₦500.00</span>
                    </label>
                </div>
                <div class="tf-cart-totals-discounts">
                    <h3>Subtotal</h3>
