                        ...
                        <div className="widget-facet wd-categories">
                            ...
                            <div className={`${openSections.categories ? 'block' : 'hidden'}`}>
                                <ul className="list-categories mb_36">
                                    <li className="cate-item current"><a href="shop-default.html">Fashion</a></li>
                                    <li className="cate-item"><a href="shop-default.html">Men</a></li>
                                    <li className="cate-item"><a href="shop-default.html">Women</a></li>
                                    <li className="cate-item"><a href="shop-default.html">Denim</a></li>
                                    <li className="cate-item"><a href="shop-default.html">Dress</a></li>
                                </ul>
                            </div>
                        </div>
